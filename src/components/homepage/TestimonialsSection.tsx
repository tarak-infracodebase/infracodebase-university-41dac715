...
const testimonials: Testimonial[] = [
  ...
  { name: "Divine Odazie", avatar: "avatars/divine-odazie.jpeg", role: "CEO @ EverythingDevOps · Cloud Native & DevOps", quote: "So happy to see this Live! After spending time to review the curriculum and go through some of the tasks, will recommend this to anyone in the infrastructure space — whether early career or experienced professionals!", accent: "purple" },
  ...
  { name: "Bojosi Elizabeth Dema", avatar: "avatars/bojosi-dema.jpeg", role: "Business Analyst · TOGAF® 9 Foundation Certified", quote: "Real learning experience, building systems, architecture — super excited about this platform." },
  { name: "Zerah Abba", avatar: "avatars/zerah-abba.jpeg", role: "Cloud · DevOps Author", quote: "This is just incredible. Love the resilience." },
  ...
  { name: "Charles (Kojo) Mark", avatar: "avatars/charles-mark.jpeg", role: "Backend → DevOps Engineer · Automating Everything: Infrastructure & Delivery", quote: "This is a great milestone for the Infracodebase team. I love this — helping junior engineers accelerate faster in their cloud career. Kudos kudos." },
];
