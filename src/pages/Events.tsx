...
const events: EventItem[] = [
  ...
  {
    id: 1,
    title: "Building Production-Ready Cloud Systems (AWS, Azure, GCP) With AI",
    series: "infracodebase",
    format: "video",
    type: "Live Webinar",
    speakers: [{ name: "Anita", role: "Developer Advocate" }, { name: "Tarak", role: "Co-Founder" }],
    link: "https://www.youtube.com/watch?v=TmsN1XMB9RQ",
    platform: "youtube",
    thumbnail: `https://img.youtube.com/vi/TmsN1XMB9RQ/maxresdefault.jpg`,
    featured: true,
    embedUrl: "https://www.youtube.com/embed/TmsN1XMB9RQ",
  },
  {
    id: 2,
