    ...
    <AppLayout>
      ...
      <div className="flex">
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="sticky top-0 lg:top-0 z-30 bg-background/95 backdrop-blur-sm border-b border-border/30">
            <div className="max-w-3xl mx-auto px-6 py-3 flex items-center justify-between gap-4 lg:max-w-none lg:pr-8">
              <div className="flex items-center gap-3 min-w-0">
                <Link to={`/path/${path.id}`} className="text-muted-foreground hover:text-foreground shrink-0">
          ...
          {/* Content area with optional sticky checklist */}
          <div className="flex">
            <div className="flex-1 min-w-0 max-w-3xl mx-auto px-6 py-8 lg:py-12">
              ...
              {/* Validation — shown inline on mobile/tablet, hidden on desktop (shown in sidebar) */}
            ...
            {/* Sticky Validation Checklist — desktop only */}
            <div className="hidden lg:block w-72 shrink-0 pr-6">
